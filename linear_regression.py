...
def main_vectorize(x,y,w,lr):
    ...
    for epoch_num in range(constants.NUM_EPOCHS):
        ...
        #     lr = utils.find_learning_rate_vectorize(x, y, w, backprop_vectorize, plt_lrs = False)
        cnt+=1
...
if __name__=="__main__":
    ...
    best_lr = utils.find_learning_rate_vectorize(x, y, w, backprop_vectorize, plt_lrs=False)
